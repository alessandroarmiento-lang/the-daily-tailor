...
export const messages = {
  it: {
    ...
    holiday: "Festività",
    precipTitle: "Precipitazioni",
    precipToday: "oggi previsti {mm} mm",
    precipHourlyAria: "Previsione oraria",
    feelsLike: "Percepiti {n}°",
    highLow: "Max {high}° / Min {low}°",
    humidity: "Umidità {n}%",
    wind: "Vento {n} km/h",
    allDay: "Tutto il giorno",
    noAgendaEvents: "Nessun evento nei prossimi giorni.",
    calendarAuth:
      "Autorizza Calendario o configura CalDAV iCloud.",
    weatherFallback: "Dati di riserva: {message}",
    noDue: "Senza scadenza",
    priorityHigh: "Priorità alta",
    priorityMedium: "Priorità media",
    priorityLow: "Priorità bassa",
    condClear: "Sereno",
    condPartlyCloudy: "Parzialmente nuvoloso",
    condCloudy: "Nuvoloso",
    condFog: "Nebbia",
  ...
  en: {
    ...
    precipToday: "today {mm} mm expected",
    precipHourlyAria: "Hourly forecast",
    feelsLike: "Feels like {n}°",
    highLow: "High {high}° / Low {low}°",
    humidity: "Humidity {n}%",
    wind: "Wind {n} km/h",
    allDay: "All day",
    noAgendaEvents: "No events in the coming days.",
    calendarAuth: "Allow Calendar or configure iCloud CalDAV.",
    weatherFallback: "Fallback data: {message}",
    noDue: "No due date",
